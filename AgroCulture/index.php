...
<html lang="en">
	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agro Culture Farm<span>maharastra</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">8329457558</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">agro123@gmail.com</a></p>
			</div>
		</div>
  ...
  <form class="modal-content animate" action="Login/login.php" method='POST'>
    ...
    <div class="3u 12u$(small)">
        <input type="radio" id="buyer_signup" name="category" value="0">
